...
Compared to the previous codeblock, how did the output change and what in the code changed it? The classes are grouped in departments. The code shows group by (term, department).
