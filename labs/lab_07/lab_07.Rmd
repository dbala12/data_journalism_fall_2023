...
**A5** So I chose the to arrange the maximum estimate per capita from highest to lowest and got the zip codes 21794 for the highest and 20854 for the lowest. These zip codes are different from my answers in question 3. So definitely less confidence. Would this because there is an overlap in estimate population and margin of error?
...
montgomery_acs_zip_percapita <- montgomery_acs_zip |> 
  mutate(
    min_est_percapita = (min_est/pop_estimate_18_up),
    max_est_percapita = (max_est/pop_estimate_18_up)
  ) |> 
