...
1.  What are the names of the top 6 classes with the highest number of seats (in any department) and how many number of seats are there available each term for those classes?

2.  How many seats on the classes for each department for each term are filled? 

3.  What is the name of the professors from which department and term teaches or has taught the classes with the highest number of seats filled arranged in descending order?
