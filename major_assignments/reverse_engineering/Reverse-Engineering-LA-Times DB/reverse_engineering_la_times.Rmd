...
-   payouts.csv: Our main spreadsheet that lists all of city's liability payouts from 2006-2018, in the months of July-March of each year. The original excel sheet this is dervied from has two tabs -- one that lists all recorded cases, and another that lists the total amount of money spent in payouts each year.
...
la_payouts <- read_csv("data/payouts/payouts.csv", guess_max = 18704)
...
* **Sentence text**: “Last budget year, the city paid out more than $200 million in legal settlements and court judgments — a record amount that was more than the city spent on its libraries or fixing its streets.”
Amount paid by city of LA for payouts by year.
* **Analysis summary**: [Write up two to three sentences describing the results of your analysis.  Were you able to confirm the finding? If not, why not?]
So the "last budget year" in the statement refers to the fiscal year 2017 and the city did indeed payout more than $200 million that year. $201,372,368.00 to be exact. And 2017 was indeed the fiscal year with the highest payouts. The second part of the statement, where it compares payouts to city spending on libraries and fixing streets is not possible using the dataset available from this story. 
```{r}
